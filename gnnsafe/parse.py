...
def parser_add_main_args(parser):
    ...
    parser.add_argument('--lamda', type=float, default=0.001, help='weight for regularization')
    ...
    ### TODO
    parser.add_argument('--use_hood', type=int,
                        default=0, help='use hard ood graph data')
